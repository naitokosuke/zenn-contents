...
Nuxt Modules の 1 つに Supabase モジュールがあります。
...
一方 Supabase ではそれらの多くの機能をまとめて簡単に利用できます。
...
Nuxt モジュールのメンテナーは経験したことがないことで、Supabase Nuxt のようなモジュールを作ることは Baptiste Leproux さんにとって目標の 1 つでした。
